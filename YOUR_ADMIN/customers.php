 ...
 * @version $Id: Zen4All Thu Nov 15 22:41:52 2018 +0100 Modified in v1.5.6a $
 */
require('includes/application_top.php');
  include(DIR_WS_FUNCTIONS . 'functions_tax_exmpt.php');
...
//BEGINNING customer tax exempt edit
		$customers_tax_exempt = zen_db_prepare_input($_POST['customers_tax_exempt']);
...
//BEGINNING customer tax exempt edit
                                array('fieldName'=>'customers_tax_exempt', 'value'=>$customers_tax_exempt, 'type'=>'stringIgnoreNull'),
//END customer tax exempt edit
        );
    ...
    case 'deleteconfirm':
      ...
      break;
    default:
//BEGINNING customer tax exempt edit	"c.customers_tax_exempt" added below
      $customers = $db->Execute("SELECT c.customers_id, c.customers_gender, c.customers_firstname,
                                          c.customers_tax_exempt,
...
<!-- BEGINNING customer tax exempt edit //-->
          <div class="form-group">
              <?php echo zen_draw_label(ENTRY_TAX_EXEMPT, 'customers_tax_exempt', 'class="col-sm-3 control-label"'); ?>
            <div class="col-sm-9 col-md-6">
                <?php echo zen_draw_input_field('customers_tax_exempt', htmlspecialchars($cInfo->customers_tax_exempt, ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_CUSTOMERS, 'customers_tax_exempt', 15) . ' class="form-control"');
				echo NOTES_TAX_EXEMPT . ' ' . TAX_EXEMPT_EXAMPLE . $example . ')'; ?>
            </div>
          </div>
<!-- END customer tax exempt edit //-->
